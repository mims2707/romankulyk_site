	...
	<div class="col-sm-4">
	               <div class="post">
					   <div class="post-media">
                            <a href="<?php the_permalink() ?>"><img alt="" class="img-responsive" src="<?php $thumbnail_attributes = wp_get_attachment_image_src( get_post_thumbnail_id(), 'medium' ); // возвращает массив параметров миниатюры
echo $thumbnail_attributes[0];?>" style="margin:auto;"></a>
                        </div>
