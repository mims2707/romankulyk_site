...
<div id="wrap">
		...
		<section id="contact-full-2" class="dark-bg bg-color1 cover-bg p100 bp280" style="background-image:url(/images/bg29.jpg);">
			<div class="container">
				...
				<p class="sep-bottom">Вам скучно и одиноко??? Пишите <i class="icon icon-emoticon-smile"></i></p>
				<form action="/scripts/contact.php" role="form" id="contact_form" novalidate="novalidate">
					<div class="form-group">
						<input type="text" class="form-control error" id="contact_name" placeholder="Имя" name="name"></input><!--<label for="contact_name" generated="true" class="error">Как Вас зовут?</label>-->
					</div>
					<div class="form-group">
			...
			if($(this).valid()){
				...
				$.ajax({
					...
					success: function() {
						...
						$('#modalMessage .modal-title').html('<i class="icon icon-envelope-open"></i>Все хорошо!<br>Ваше сообщение было успешно отослано!');
